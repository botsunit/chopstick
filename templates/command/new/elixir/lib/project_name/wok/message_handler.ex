defmodule <%= project_name_camelize %>.Wok.MessageHandler do
  require Bitwise
  require Record
  ...
  defp make_options do
    [] |> is_compressed(Mix.env)
  end
  defp is_compressed(acc,:prod), do: [:compressed | acc]
  defp is_compressed(acc,_), do: acc
end
